      ...
      <div class="bg-fantasy text-center p-5 rounded-lg shadow-lg text-white overflow-y-auto grid grid-cols-[1fr_2fr_1fr] gap-4">
        ...
        <div>
          ...
          <div class=" grid grid-rows">
            <div class="flex flex-row items-center justify-center p-5 space-x-4">
                <image src="" alt="Character Image" class="w-24 h-24 rounded-full"/>
                <div>
                    <h1>Character Name</h1>
                    <input type="text" placeholder="Enter character name" class=" p-2 rounded-lg mb-4 text-black"/>
                </div>
            </div>
